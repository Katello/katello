...
FEWUPS_REPO_URL="http://lzap.fedorapeople.org/fakerepos/zoo3/"
...
test_success "environment create ($TEST_ENV)" environment create --org="$TEST_ORG" --name="$TEST_ENV" --prior="Locker"
