...
test_success "permission create with verbs & tags" permission create --user_role=$ROLE_NAME --name="$ENV_PERMISSION_NAME_2" --scope="environments" --verbs="read_contents" --tags="Locker" --org="$TEST_ORG"
