...
test "template update" template update --name="$TEMPLATE_NAME_2" --new_name="changed_$TEMPLATE_NAME_2" --description="changed description" --org="$TEST_ORG" --environment="Locker"
...
test "template update_content add package" template update_content --name="$TEMPLATE_NAME" --org="$TEST_ORG"    --add_package    --package="warnerbros"
test "template update_content remove package" template update_content --name="$TEMPLATE_NAME" --org="$TEST_ORG" --remove_package --package="warnerbros"
test "template update_content add erratum" template update_content --name="$TEMPLATE_NAME" --org="$TEST_ORG"    --add_erratum    --erratum="RHEA-2010:9999"
test "template update_content remove erratum" template update_content --name="$TEMPLATE_NAME" --org="$TEST_ORG" --remove_erratum --erratum="RHEA-2010:9999"
