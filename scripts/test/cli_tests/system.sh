...
test "system register with activation key" system register --name="$SYSTEM_NAME_ADMIN" --org="$FIRST_ORG" --activationkey="$ACTIVATION_KEY_NAME_1,$ACTIVATION_KEY_NAME_2"
