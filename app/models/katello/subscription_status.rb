module Katello
  class SubscriptionStatus < HostStatus::Status
    ...
    def to_status(_options = {})
      return UNKNOWN unless host.subscription_aspect.try(:uuid)
      case Katello::Candlepin::Consumer.new(host.subscription_aspect.uuid).entitlement_status
    ...
    def relevant?
      host.subscription_aspect.try(:uuid)
    end
  end
end
