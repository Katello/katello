...
module Katello
  module UserExtensions
    ...
    included do
      ...
      #has_many :roles_users, :class_name => Katello::RolesUser
      #has_many :roles, :through => :roles_users, :before_remove => :super_admin_check, :uniq => true,
      #         :extend => RolesPermissions::UserOwnRole, :class_name => Katello::Role
