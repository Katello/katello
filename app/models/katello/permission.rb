...
module Katello
class Permission < Katello::Model
  ...
  belongs_to :resource_type, :inverse_of => :permission # TODO: belongs_to permission on the other side
  belongs_to :organization, :class_name => "Organization", :inverse_of => :permissions
