...
module Katello
  module OrganizationExtensions
    ...
    included do
      ...
      # ENGINIFY: Add back redhat provider
      #before_create :create_redhat_provider
      # ENGINIFY: Until we set the DB columns
      ...
      # ENGINIFY: Add default_info column
      ...
      def being_deleted?
        # ENGINIFY: Return to this once organization deletion is figured out
