module Katello
  class Repository < Katello::Model
    ...
    has_many :content_aspect_repositories, :class_name => "Katello::ContentAspectRepository", :dependent => :destroy
    has_many :content_aspects, :through => :content_aspect_repositories
