          ...
          sequence do
            concurrence do
              repos_to_copy(old_version, new_components).each do |source_repo|
                copy_repo(source_repo, new_content_view_version, content, dep_solve)
              end
              ...
              sequence do
                ...
                copy_puppet_content(new_puppet_environment, content[:puppet_module_ids]) unless content[:puppet_module_ids].blank?
              end
            end
