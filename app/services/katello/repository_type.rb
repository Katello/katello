module Katello
  class RepositoryType
    ...
    def_field :allow_creation_by_user, :service_class, :default_removable_type
    ...
    class ContentType
      attr_accessor :model_class, :priority, :pulp2_service_class, :index, :uploadable, :removable
