module Katello
  class RepositoryType
    ...
    def repository_remote_options
      @repository_remote_options.sort_by(&:name)
    end
    ...
    def repository_remote_option(name, options = {})
      @repository_remote_options ||= []
      @repository_remote_options << RepositoryRemoteOptions.new(options.merge(:name => name))
    end
