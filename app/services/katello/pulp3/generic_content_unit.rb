module Katello
  module Pulp3
    class GenericContentUnit < PulpContentUnit
      ...
      def self.fetch_content_list(page_opts, repository_type)
        content_unit_list page_opts, repository_type
      end

      def self.content_unit_list(page_opts, repository_type)
        self.content_api(repository_type).list page_opts
      end
      ...
      def update_model(model, repository_type)
        custom_json = {}
