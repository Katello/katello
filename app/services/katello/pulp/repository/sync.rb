module Katello
  module Pulp
    module Repository
      class Sync < Actions::Pulp::AbstractAsyncTask
        include Actions::Helpers::Presenter
        ...
        def presenter
          ...
          if repo.try(:puppet?)
            Actions::Pulp::Repository::Presenters::PuppetPresenter.new(self)
          elsif repo.try(:yum?)
            Actions::Pulp::Repository::Presenters::YumPresenter.new(self)
          elsif repo.try(:file?)
            Actions::Pulp::Repository::Presenters::FileUnitPresenter.new(self)
          elsif repo.try(:docker?)
            Actions::Pulp::Repository::Presenters::DockerPresenter.new(self)
          elsif repo.try(:ostree?)
            Actions::Pulp::Repository::Presenters::OstreePresenter.new(self)
          elsif repo.try(:deb?)
            Actions::Pulp::Repository::Presenters::DebPresenter.new(self)
          end
        end
