module Katello
  class RepositoryTypeManager
    ...
    class << self
      ...
      def enabled_repository_types
        if (defined_repository_types.keys - @enabled_repository_types.keys).present?
          defined_repository_types.keys.each { |repo_type| update_enabled_repository_type(repo_type.to_s) }
        end
        @enabled_repository_types
      end
      ...
      def find(repository_type)
        found_repo_type = enabled_repository_types[repository_type.to_s]
