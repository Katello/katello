module Katello
  class Api::V2::ContentViewsController < Api::V2::ApiController
    ...
    param :hostgroup_content_view_id, :number, :desc => N_("content view to reassign orphaned host groups to")
    param :hostgroup_environment_id, :number, :desc => N_("environment to reassign orphaned host groups to")
