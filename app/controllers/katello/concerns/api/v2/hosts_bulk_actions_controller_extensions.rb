  ...
  module Concerns
    ...
    module Api::V2::HostsBulkActionsControllerExtensions
      ...
      module Overrides
        ...
        def assign_taxonomy
          if params[:taxonomy_type].downcase == 'organization'
            registered_host = find_editable_hosts.where.not(organization_id: params[:taxonomy_id]).joins(:subscription_facet).first
            if registered_host
