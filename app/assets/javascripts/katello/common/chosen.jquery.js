...
// Modified to support a new option custom_compare, at some point we should go back and add this
// to the coffeescript version
(function() {
  var SelectParser;
  ...
  */
  ...
  Chosen = (function() {
    ...
    Chosen.prototype.result_add_group = function(group) {
      if (!group.disabled) {
        group.dom_id = this.container_id + "_o_" + group.array_index;
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        ...
        if (!option.disabled && !option.empty) {
          if (option.group) {
            ...
            if(this.options.custom_compare) {
                var item = this.results_data[option.dom_id.substr(option.dom_id.lastIndexOf("_") + 1)].value;
