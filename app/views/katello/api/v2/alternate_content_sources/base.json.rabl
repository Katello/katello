...
if @object.respond_to?(:alternate_content_source_type)
  if @object.custom? || @object.rhui?
    attributes :name, :alternate_content_source_type, :content_type, :base_url, :subpaths, :distributions, :components, :architectures, :upstream_username, :smart_proxies, :verify_ssl, :use_http_proxies
