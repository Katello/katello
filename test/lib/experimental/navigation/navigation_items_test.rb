...
class NavigationItemsTest < MiniTest::Rails::ActiveSupport::TestCase
  ...
  def test_dashboard_item
    item = Experimental::Navigation::Items::Dashboard.new
  ...
  def test_content_seach_item
    item = Experimental::Navigation::Items::ContentSearch.new(@acme_corporation)
  ...
  def test_content_view_definitions_item
    item = Experimental::Navigation::Items::ContentViewDefinitions.new(@acme_corporation)
  ...
  def test_systems_item
    item = Experimental::Navigation::Items::Systems.new(@acme_corporation)
  ...
  def test_systems_by_environments_item
    item = Experimental::Navigation::Items::SystemsByEnvironment.new(@acme_corporation)
  ...
  def test_system_groups_item
    item_item = Experimental::Navigation::Items::SystemGroups.new(@acme_corporation)
  ...
  def test_organizations_item
    item = Experimental::Navigation::Items::Organizations.new
  ...
  def test_synchronization_item
    item = Experimental::Navigation::Items::Synchronization.new
  ...
  def test_users_item
    item = Experimental::Navigation::Items::Users.new
  ...
  def test_roles_item
    item = Experimental::Navigation::Items::Roles.new
  ...
  def test_item
    item = Experimental::Navigation::Items::About.new
  ...
  def test_changesets_item
    item = Experimental::Navigation::Items::Changesets.new(@acme_corporation)
  ...
  def test_changesets_history_item
    item = Experimental::Navigation::Items::ChangesetHistory.new(@acme_corporation)
  ...
  def test_subscriptions_item
    item = Experimental::Navigation::Items::Subscriptions.new(@acme_corporation)
  ...
  def test_distributors_item
    item = Experimental::Navigation::Items::Distributors.new(@acme_corporation)
  ...
  def test_activation_keys_item
    item = Experimental::Navigation::Items::ActivationKeys.new(@acme_corporation)
  ...
  def test_import_history_item
    item = Experimental::Navigation::Items::ImportHistory.new(@acme_corporation)
  ...
  def test_providers_item
    item = Experimental::Navigation::Items::Providers.new(@acme_corporation)
  ...
  def test_redhat_provider_item
    item = Experimental::Navigation::Items::RedhatProvider.new(@acme_corporation)
  ...
  def test_gpg_keys_item
    item = Experimental::Navigation::Items::GpgKeys.new(@acme_corporation)
  ...
  def test_sync_status_item
    item = Experimental::Navigation::Items::SyncStatus.new
  ...
  def test_sync_plans_item
    item = Experimental::Navigation::Items::SyncPlans.new
  ...
  def test_sync_schedules_item
    item = Experimental::Navigation::Items::SyncSchedule.new
  ...
  def test_user_account_item
    item = Experimental::Navigation::Items::UserAccount.new(@admin)

    assert_equal  _('My Account'), item.display
    assert_equal  "#{users_path(@admin)}#panel=user_#{@admin.id}", item.url
    assert        item.accessible?
  end

  def test_logout_item
    item = Experimental::Navigation::Items::Logout.new
