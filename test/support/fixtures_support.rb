module Katello
  module FixturesSupport
    FIXTURE_CLASSES = {
      ...
      :katello_module_stream_erratum_packages => Katello::ModuleStreamErratumPackage,
      ...
      :katello_repository_file_units => Katello::RepositoryFileUnit,
      :katello_repository_generic_content_units => Katello::RepositoryGenericContentUnit,
