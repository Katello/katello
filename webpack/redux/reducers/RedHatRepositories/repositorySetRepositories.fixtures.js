...
export const requestSuccessResponse = Immutable({
  ...
  results: [
    ...
    },
    {
      ...
      path: '/content/beta/layered/rhel8/x86_64/fast-datapath/os',
      repo_name: 'Fast Datapath Beta for RHEL 8 x86_64 RPMs',
      pulp_id: 'd06a10ff-89ac-4e26-a9e6-075ca44e135a',
