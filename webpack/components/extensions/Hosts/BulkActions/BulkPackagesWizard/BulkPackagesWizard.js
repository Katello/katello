...
const BulkPackagesWizard = () => {
  ...
  const getOSFamily = () => {
    if (currentlySelectedHosts === undefined) { return BULK_ACTIONS_OSFAMILY.INVALID; } else if (currentlySelectedHosts[0]?.operatingsystem_family === 'Debian') { return BULK_ACTIONS_OSFAMILY.DEBIAN; }
