export const POLL_TASK_STARTED = 'POLL_TASK_STARTED';
...
export const TASK_BULK_SEARCH_SKIPPED = 'TASK_BULK_SEARCH_SKIPPED';
export const TASK_BULK_SEARCH_CANCELLED = 'TASK_BULK_SEARCH_CANCELLED';
