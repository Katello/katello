...
const FlatpakRemotesForm = ({ setModalOpen, remoteData, hasRedhatRemote }) => {
  ...
  return (
    ...
    >
      ...
      >
        <TextContent>
          {__('To continue with Red Hat Flatpack remote, you need to generate your username and password in')} <a target="_blank" href="https://access.redhat.com/terms-based-registry/" rel="noreferrer">access.redhat.com/terms-based-registry/</a>
        </TextContent>
      </Alert>
      )}
