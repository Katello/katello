export const UPLOAD_MANIFEST_KEY = 'UPLOAD_MANIFEST';
export const REFRESH_MANIFEST_KEY = 'REFRESH_MANIFEST';
export const DELETE_MANIFEST_KEY = 'DELETE_MANIFEST';
export const MANIFEST_HISTORY_KEY = 'MANIFEST_HISTORY';
