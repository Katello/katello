    ...
    TYPES = {
       ...
       :package_install => {
            ...
            :event_messages => {
                ...
                :success => [N_('Package Install Complete'), N_('%s package installed'), N_('%s (%s other packages) installed')],
        ...
        :package_update => {
            ...
            :event_messages => {
                ...
                :success =>[N_('Package Update Complete'), N_('%s package updated'), N_('%s (%s other packages) updated')],
        ...
        :package_remove => {
            ...
            :event_messages => {
                ...
                :success => [N_('Package Remove Complete'), N_('%s package removed'), N_('%s (%s other packages) removed')],
        ...
        :package_group_install => {
            ...
            :event_messages => {
                ...
                :success => [N_('Package Group Install Complete'), N_('%s package group installed'), N_('%s (%s other package groups) installed')],
        ...
        :package_group_update => {
            ...
            :event_messages => {
                ...
                :success =>[N_('package group update complete'), N_('%s package group updated'), N_('%s (%s other package groups) updated')],
        ...
        :package_group_remove => {
            ...
            :event_messages => {
                ...
                :success => [N_('Package Group Remove Complete'), N_('%s package group removed'), N_('%s (%s other package groups) removed')],
        ...
        :errata_install => {
            ...
            :event_messages => {
                ...
                :success => [N_('Erratum Install Complete'), N_('%s erratum installed'), N_('%s (%s other errata) installed')],
