  ...
  def self.up
    ...
    KTEnvironment.all.each do |env|
      unless env.content_view_environment
        ...
        query = ActiveRecord::Base.connection.raw_connection.prepare('insert_cvve', "insert into content_view_version_environments (content_view_version_id, environment_id, created_at, updated_at) values ($1, $2, $3, $4)")
