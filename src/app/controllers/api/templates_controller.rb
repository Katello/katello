...
class Api::TemplatesController < Api::ApiController
  ...
  def create
    raise HttpErrors::BadRequest, _("New templates can be created only in a Library environment") if not @environment.locker?
  ...
  def update
    raise HttpErrors::BadRequest, _("Templates can be updated only in a Library environment") if not @template.environment.locker?
  ...
  def import
    raise HttpErrors::BadRequest, _("New templates can be imported only into a Library environment") if not @environment.locker?
  ...
  def validate
    raise HttpErrors::BadRequest, _("Cannot validate templates for the Library environment.") if @template.environment.locker?
  ...
  def export
    raise HttpErrors::BadRequest, _("Cannot export templates for the Library environment.") if @template.environment.locker?
