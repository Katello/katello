...
describe User do
  ...
  describe "Users in LDAP should" do
    ...
    it "have permission for two orgs" do
      disable_org_orchestration
      org = Organization.create!(:name=>'test_organization', :label=> 'test_organization', :cp_key => 'test_organization')
      moreorg = Organization.create!(:name=>'another_test_organization', :label=> 'another_test_organization', :cp_key => 'another_test_organization')
