...
skip_test_success "provider delete" "delete imported issue" provider delete --org="$IMPORT_ORG" --name="$IMPORT_PROV"
skip_test_success "org delete" "delete imported issue" org delete --name=$IMPORT_ORG
