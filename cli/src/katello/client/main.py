...
def setup_admin(katello_cmd, mode=get_katello_mode()):
    ...
    akey_cmd.add_command('import', activation_key.ImportActivationKeys())
    ...
    env_cmd.add_command('import', environment.ImportEnvironments())
    ...
    org_cmd.add_command('import', organization.ImportOrgs())
    ...
    user_cmd.add_command('import', user.ImportUsers())
    ...
    if mode == 'katello':
        ...
        system_group_cmd.add_command('import', system_group.ImportSystemGroups())
