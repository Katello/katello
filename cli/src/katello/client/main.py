...
def setup_admin(katello_cmd, mode=get_katello_mode()):
    ...
    org_cmd.add_command("add_default_info", organization.AddDefaultInfo())
    org_cmd.add_command("remove_default_info", organization.RemoveDefaultInfo())
    org_cmd.add_command("apply_default_info", organization.ApplyDefaultInfo())
