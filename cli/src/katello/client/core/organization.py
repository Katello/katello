...
class Info(OrganizationAction):
    ...
    def run(self):
        ...
        self.printer.add_column('system_info_keys', name=_("Default System Info Keys"), multiline=True, show_with=printer.VerboseStrategy)
...
class AddDefaultSystemInfo(OrganizationAction):
    ...
    def run(self):
        ...
        if response:
            ...
            print _("Could not add default custom info key [ %s ] to Org ")
