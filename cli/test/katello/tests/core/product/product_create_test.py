...
class CreateTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.create_action.api.create.return_value = { 'id': self.PRODUCT_ID, 'name':self.PRODUCT, 'label':self.PRODUCT_LABEL }
    ...
    def test_finds_provider(self):
        self.create_action.create_product_with_repos(self.PROVIDER, self.ORGANIZATION, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, self.URL, self.ASSUMEYES, self.NODISC, None, False)
    ...
    def test_creates_product(self):
        self.create_action.create_product_with_repos(self.PROVIDER, self.ORGANIZATION, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, self.URL, self.ASSUMEYES, self.NODISC, None, False)
        self.create_action.api.create.assert_called_once_with(self.PROVIDER_ID, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, None)

    def test_discovers_repos(self):
        self.create_action.create_product_with_repos(self.PROVIDER, self.ORGANIZATION, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, self.URL, self.ASSUMEYES, self.NODISC, None, False)
        self.create_action.discoverRepos.discover_repositories.assert_called_once_with(self.PROVIDER_ID, self.URL)

    def test_creates_product_without_repositories_if_url_was_not_specified(self):
        self.create_action.create_product_with_repos(self.PROVIDER, self.ORGANIZATION, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, None, self.ASSUMEYES, self.NODISC, None, False)
    ...
    def test_create_repos(self):
        self.create_action.create_product_with_repos(self.PROVIDER, self.ORGANIZATION, self.PRODUCT, self.PRODUCT_LABEL, self.DESCRIPTION, self.URL, self.ASSUMEYES, self.NODISC, None, False)
        self.create_action.discoverRepos.create_repositories.assert_called_once_with(self.ORGANIZATION, self.PRODUCT_ID, self.PRODUCT, self.PRODUCT_LABEL, self.DISCOVERED_REPOS, False)
