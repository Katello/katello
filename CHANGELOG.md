# 3.16.0 Tasty Taiyaki (2020-06-15)
...
### Errata Management
 * indexing a yum repo with pulp3 fails to calculate nvra at first indexing ([#30118](https://projects.theforeman.org/issues/30118))
