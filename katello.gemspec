...
Gem::Specification.new do |gem|
  ...
  #pulp3
  gem.add_dependency "pulpcore_client", ">= 3.4.0", "< 3.5.0"
  ...
  gem.add_dependency "pulp_rpm_client", ">=3.4.0", "< 3.5.0"
  gem.add_dependency "pulp_2to3_migration_client", "> 0.02b2", "< 0.3.0"
