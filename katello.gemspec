...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "pulpcore_client", ">= 3.118.0", "< 3.119.0"
  gem.add_dependency "pulp_file_client", ">= 3.118.0", "< 3.119.0"
  gem.add_dependency "pulp_ansible_client", ">= 0.30.0", "< 0.31.0"
  gem.add_dependency "pulp_container_client", ">= 2.29.0", "< 2.30.0"
  gem.add_dependency "pulp_deb_client", ">= 3.11.1", "< 3.12.0"
  gem.add_dependency "pulp_rpm_client", ">= 3.39.0", "< 3.40.0"
  gem.add_dependency "pulp_certguard_client", ">= 3.118.0", "< 3.119.0"
  gem.add_dependency "pulp_python_client", ">= 3.36.2", "< 3.37.0"
  gem.add_dependency "pulp_ostree_client", ">= 2.6.1", "< 2.7.0"
