...
Gem::Specification.new do |gem|
  ...
  #pulp3
  gem.add_dependency "pulpcore_client", ">= 3.49.3", "< 3.50.0"
  gem.add_dependency "pulp_file_client", ">= 3.49.3", "< 3.50.0"
  ...
  gem.add_dependency "pulp_rpm_client", ">= 3.25.1", "< 3.26.0"
  gem.add_dependency "pulp_certguard_client", ">= 3.49.3", "< 3.50.0"
