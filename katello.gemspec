...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "foreman-tasks", ">= 9.1", "< 11.0.1"
  gem.add_dependency "foreman_remote_execution", ">= 7.1.0", "< 16.2.0"
  ...
  gem.add_dependency "pulp_python_client", ">= 3.13.0", "< 3.14.0"
