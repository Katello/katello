...
Gem::Specification.new do |gem|
  ...
  gem.add_dependency "foreman-tasks", ">= 9.1", "< 12.0.0"
  ...
  gem.add_dependency "pulp_certguard_client", ">= 3.85.0", "< 3.85.4"
  gem.add_dependency "pulp_python_client", ">= 3.19.0", "< 3.19.2"
  gem.add_dependency "pulp_ostree_client", ">= 2.5.0", "< 2.5.1"
