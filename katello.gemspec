...
Gem::Specification.new do |gem|
  ...
  # Pulp dependencies
  gem.add_dependency "pulpcore_client", ">= 3.49.1", "<  3.49.14"
  gem.add_dependency "pulp_file_client", ">= 3.49.1", "< 3.49.14"
  ...
  gem.add_dependency "pulp_certguard_client", ">= 3.49.1", "< 3.49.14"
