 ...
 * @example
 */
angular.module('Bastion.widgets').directive('pathSelectorWrapper',
    ['$document', '$http', 'Routes', function ($document, $http, Routes) {
    return {
        restrict: 'AE',
        scope: {
            pathSelector: '=pathSelectorWrapper',
            readonly: '=',
            organization: '&',
            onChange: '&',
            mode: '@'
        ...
        link: function (scope) {
            ...
            scope.$parent.setupSelector = function () {
                return $http.get(Routes.organizationEnvironmentsPath(scope.organization()) + '/registerable_paths')
                            .success(function (paths) {
                                var options = {
                                        inline: true,
                                        'select_mode': scope.mode ? scope.mode : 'single',
                                        expand: false,
