...
describe('Factory: Filter', function() {
    ...
    it('provides a way to get a collection of filters', function() {
        $httpBackend.expectGET('/api/v2/filters?content_view_id=1')
                    .respond(filters);
    ...
    it('provides a way to get a single filter', function() {
        $httpBackend.expectGET('/api/v2/filters/1?content_view_id=1')
    ...
    it('provides a way to create a filter', function() {
        ...
        $httpBackend.expectPOST('/api/v2/filters/1?content_view_id=1')
                    .respond(filter);
    ...
    it('provides a way to update a filter', function() {
        $httpBackend.expectPUT('/api/v2/filters/1?content_view_id=1')
                    .respond(filters.results[0]);
    ...
    it('provides a way to get available errata for a filter', function() {
        $httpBackend.expectGET('/api/v2/filters/1/available_errata?content_view_id=1')
                    .respond({});
    ...
    it('provides a way to retrieve current errata on a filter', function() {
        $httpBackend.expectGET('/api/v2/filters/1/errata?content_view_id=1')
                    .respond({});
