...
angular.module('Bastion.ostree-branches').controller('OstreeBranchesController',
    ['$scope', '$location', 'translate', 'Nutupane', 'OstreeBranch', 'Task', 'Repository', 'CurrentOrganization',
    function ($scope, $location, translate, Nutupane, OstreeBranch, Task, Repository, CurrentOrganization) {
        var nutupane, params = {
