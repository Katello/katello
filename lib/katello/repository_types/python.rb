...
Katello::RepositoryTypeManager.register('python') do
  ...
  repository_remote_option :includes, type: Array, description: "A list containing project specifiers for Python packages to include."
  repository_remote_option :excludes, type: Array, description: "A list containing project specifiers for Python packages to exclude."
  repository_remote_option :package_types, type: Array, description: "A list of package types to sync for Python content. Leave blank to get every package type."
