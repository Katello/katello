    ...
    task :test => ['db:test:prepare'] do
      ...
      test_task = Rake::TestTask.new('katello_test_task') do |t|
        ...
        t.test_files = [
          ...
          "#{Katello::Engine.root}/test/models/erratum_filter_test.rb",
          "#{Katello::Engine.root}/test/models/package_filter_test.rb",
          "#{Katello::Engine.root}/test/models/package_group_filter_test.rb",
