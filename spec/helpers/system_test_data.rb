...
module Katello
    ...
    class << self
      def virtual_guests
        [{"href" => "/consumers/fcba65f1-5fe4-42e0-8f7b-6c719ec2bc42",
          ...
          "owner" =>       {"href" => "/owners/ACME_Corporation",
      ...
      def host
        {"href" => "/consumers/f4ca72d5-d087-49e3-a3bd-1012e12328d4",
         ...
         "guestIds" =>       [{"id" => "4028fa81338751be0133876749fd0012",
      ...
      def new_hypervisor
        {"href" => "/consumers/host2",
         ...
         "name" => "host2",
         "entitlementCount" => 0,
         "idCert" =>       {"serial" =>        {"serial" => 7_270_161_947_420_840_345,
                                                "revoked" => false,
                                                "expiration" => "2012-12-22T10:19:23.355+0000",
                                                "id" => 7_270_161_947_420_840_345,
  ...
  RSA PRIVATE KEY-----\n",
         ...
         "autoheal" => true,
         "uuid" => "host2",
         "guestIds" => [{"id" => "4028fa81346539d6013465484d07000c",
                         "guestId" => "GUEST3",
