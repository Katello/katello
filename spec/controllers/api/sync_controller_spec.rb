...
describe Api::SyncController, :katello => true do
  ...
  def stub_product_with_repo
      ...
      @repository = Repository.create!(:environment_product => ep, :name=> "repo_1", :label=> "repo_1_label",
                                       :pulp_id=>"1", :feed => 'https://localhost')
      Repository.stub(:find).and_return(@repository)
      @repository2 = Repository.create!(:environment_product => ep, :name=> "repo_2", :label=> "repo_2_label",
                                        :pulp_id=>"2", :feed => 'https://localhost')
      Repository.stub(:find).and_return(@repository)
  end
