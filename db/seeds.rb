...
user_admin.update_attributes(:remote_id => first_user_name)
...
if Katello::Provider.count == 0
  Katello::Provider.create!({
      ...
      #Can't mass-assign protected attributes: repository_url
...
if Katello.config.use_pulp
  # TODO - error - undefined method `resources' for nil:NilClass
