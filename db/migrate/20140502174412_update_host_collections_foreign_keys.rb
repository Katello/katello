class UpdateHostCollectionsForeignKeys < ActiveRecord::Migration
  ...
  def down
    ...
    remove_foreign_key "katello_key_host_collections", :name => "key_host_collections_system_group_id_fk"

    remove_foreign_key "katello_system_host_collections", :name => "system_host_collections_system_group_id_fk"
